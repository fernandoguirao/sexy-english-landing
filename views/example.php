<!-- header-1 -->
        <header class="header-1">
            <div class="container">
                <div class="row">
                    <div class="navbar span12 navbar-fixed-top">
        ...
        <section class="video">
            ...
            <div id="bgVideo" class="background">
              <video id="video_background" preload="auto" autoplay="autoplay" loop="loop" style="top: -117px; left: 0px; bottom: 0px; right: 0px; z-index: -100; width: 1225px; height: 689.0625px;">
                <source src="media/sexy-english.mp4" type="video/mp4">
                <source src="media/sexy-english.ogg" type="video/ogg">
                <source src="media/sexy-english.webm" type="video/webm">
                bgvideo
              </video>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="row features">
                    <div class="span4">
                        ...
                        <h6>Money Economy</h6>
                        <p>Startups can save money on design and code and spend it on concept and functionality.</p>
                    </div>
                    <div class="span4">
                        <img src="img/illustrations/magic@2x.png" alt="" width="100" height="100">
                        <h6>Based on Bootstrap</h6>
                        <p>HTML layout is based on one of the common frameworks at this time - Bootstrap v 2.3.2</p>
                    </div>
                    <div class="span4">
                        <img src="img/illustrations/box@2x.png" alt="" width="176" height="127" style="left: -90px;">
                        <h6>Responsive Layout</h6>
                        <p>Create a website with full mobile support.</p>
                    </div>
                </div>    
             </div>       
        </section>       
...
<!-- footer-6 -->
        <footer class="footer-6">
            <div class="container">
                <div class="row">
                    <div class="span3">
                        <div><a class="brand" href="#">Startup</a></div>                       
                    </div>
                    <nav>
                        <div class="span2">
                            <h6>About</h6>
